...
namespace Zhaiwenjun\IcbcJft\QueryOrderV1;

use Zhaiwenjun\IcbcJft\Contract\Base;
use Zhaiwenjun\IcbcJft\Contract\RequestData\QueryOrderV1Data;
...
class SDK extends Base
{
    ...
    {
        if (!$requestData instanceof QueryOrderV1Data) {
       ...
       Log::getLogger('QueryOrderV1.log',$this->logPath)->info('request:',$requestMergeData);
       $rtn = $client->execute($requestMergeData, $msgId, '');
       Log::getLogger('QueryOrderV1.log',$this->logPath)->info('response:'.$rtn);
       return $rtn;
    }
